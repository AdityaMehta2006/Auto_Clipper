...
export default function FileCard({ video, onAnalyze, onViewClips, analyzing }) {
            ...
            <Card sx={{ height: '100%', display: 'flex', flexDirection: 'column' }}>
                ...
                <CardContent sx={{ flex: 1, display: 'flex', flexDirection: 'column', p: 2.5 }}>
                    ...
                    <Box sx={{ display: 'flex', gap: 1.5, mb: 2 }}>
                        ...
                        <Box sx={{ display: 'flex', alignItems: 'center', gap: 0.5 }}>
                            <Description sx={{ fontSize: 16, color: 'secondary.main' }} />
                            <Typography variant="caption" sx={{ color: 'text.secondary' }}>Transcript</Typography>
                        </Box>
                    </Box>
                            ...
                            analyzing ? (
                                ...
                                <motion.div whileTap={{ scale: 0.98 }}>
                                    <Box sx={{ mb: 2, display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
                                        <Typography variant="caption" color="text.secondary">Analysis Mode</Typography>
                                        <FormControlLabel
                                            control={
                                                <Switch
                                                    size="small"
